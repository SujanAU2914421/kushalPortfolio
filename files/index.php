					...
					>
						<div class="relative h-screen w-screen">
							<div class="fixed top-0 left-0 h-screen w-screen">
								...
								>
									<video
										src="./y2mate.com - MODEL VIDEO PROFILE_1080p.mp4"
										muted
							...
							>
								<div class="relative h-auto w-auto grid gap-4">
									<div
										class="relative h-auto w-auto xl:text-7xl lg:text-7xl md:text-5xl sm:text-3xl text-xl font-extrabold uppercase grid gap-1"
									>
										<div style="letter-spacing: 2px">See</div>
										<div style="word-spacing: 5px; letter-spacing: 2px">
											the new
										</div>
										<div style="letter-spacing: 2px">racers</div>
									</div>
									<div
										class="relative h-auto w-auto xl:text-normal lg:text-normal md:text-sm text-xs font-light"
									>
										Do you want to be the new flow of k-entertainment
									</div>
									<?php
										if(!$_SESSION['email']){
											echo "
											...
											<div
											class='relative h-[50px] w-[200px] text-sm font-bold capitalize text-gray-800 bg-white flex items-center justify-center'
											>
											Sign up now
											</div>
											</a>
										...
										?>
									<div
										class="relative h-auto want flex items-center gap-3 text-white text-xl"
									>
										<a href="" target="_blank">
											<div
												class="relative h-[35px] w-[35px] flex items-center justify-center rounded"
											>
												<svg
													xmlns="http://www.w3.org/2000/svg"
													width="24"
